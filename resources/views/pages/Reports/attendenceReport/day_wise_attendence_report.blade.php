...
@section('title', 'Day Wise Attendence Report')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Day Wise Attendence Report</h4>
                        <button type="button" id="exportBtn" onclick="exportBtn('Attendence Report')"
                            class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('day_wise_attendence_report') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
