                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>From</label>
                                        <input type="date"  name="from" id="date" class="form-control" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>To</label>
                                        <input type="date"  name="to" id="date" class="form-control" value="">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="shop_id" name="shop_id" required>
                                            ...
                                            @foreach ($shops as $shop)
                                                <option value="{{$shop->id}}" {{$request->shop_id == $shop->id ? 'selected' : ''}}>{{$shop->company_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
