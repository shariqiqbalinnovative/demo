                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <label>{{$user_data->tso->designation->name}}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <label>{{$user_data->tso->company_name?? '--'}}</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <label>{{$user_data->tso->tso_code ?? '--'}}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <label>{{$user_data->tso->emp_id?? '--'}}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <label>{{$user_data->tso->phone?? '--'}}</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Address</label>
                                <br>
                                <label>{{$user_data->tso->address ?? '--'}}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>CNIC</label>
                                <br>
                                <label>{{$user_data->tso->cnic ?? '--'}}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>City</label>
                                <br>
                                <label>{{$user_data->tso->cities->name ?? '--'}}</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>State</label>
                                <br>
                                <label>{{$user_data->tso->state ?? '--'}}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Country</label>
                                <br>
                                <label>{{$user_data->tso->country ?? '--'}}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <label>{{$user_data->tso->date_of_join ?? '--'}}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <label>{{$user_data->tso->date_of_leaving ?? '--'}}</label>
                            </div>
                        </div>
                    </div>
                </div>
