                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" class="form-control"
                                                            placeholder="Location Title" name="location_name" id="location_name"/></td>
                                                    <td><input type="number" step="any" readonly id="lat" class="form-control" placeholder="Latitude"
                                                            name="latitude" /></td>
                                                    <td><input type="number" step="any" readonly id="lon" class="form-control" placeholder="Longitude"
                                                            name="longitude" /></td>
                                                    <td><input type="number" step="any" id="radius" class="form-control" placeholder="Radius (KM)"
                                                            name="radius" /></td>
                                                </tr>
