@foreach ($type as $key => $row)
    <tr>
        ...
        <td>
            <!-- <div>
                @can('Price_Type_Edit')
                    <a href="{{ route('priceType.edit', $row) }}" class="btn btn-primary btn-sm">Edit</a>
                @endcan
                @can('Price_Type_Delete')
                    <button type="button" id="delete-user" data-url="{{ route('priceType.destroy', $row->id) }}"
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu_sale_order_list" aria-labelledby="dropdownMenuButton">
                     @can('Price_Type_Edit')
                        <a href="{{ route('priceType.edit', $row) }}" class="dropdown-item_sale_order_list dropdown-item">Edit</a>
                    @endcan
                    @can('Price_Type_Delete')
                        <a href="{{ route('priceType.destroy', $row->id) }}" id="delete-user" class="dropdown-item_sale_order_list dropdown-item" href="#">Delete</a>
                    @endcan
                </div>
            </div>
